...
import lawrenceLogo from "@/assets/projects/lawrence.png";
      ...
      <div className="container max-w-5xl">
        ...
        >
          <div className="flex items-start gap-5 flex-wrap">
            {/* College logo */}
            <div className="w-14 h-14 rounded-2xl bg-white border border-border flex items-center justify-center shrink-0 overflow-hidden p-1">
              <img
                src={lawrenceLogo}
            ...
            <div className="flex-1 min-w-[260px]">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Apr 2021 — Sep 2025 · Final Grade:{" "}
                <span className="text-primary font-medium">71.83%</span>
              </p>
            </div>
          </div>
